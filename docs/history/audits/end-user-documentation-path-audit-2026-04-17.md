...
| [docs/implementation-status.md](../plans/implementation-status-2026-06-06.md) | Fixed validation rule count (13→16), test count (598→627), documented STWD-014/015/016 as delivered, removed stale "required-sections deferred" claim |
| [docs/planning/pre-1-0-readiness-plan.md](../plans/pre-1-0-readiness-plan-2026-06-05.md) | Marked required-sections, naming-pattern, and min-count enforcement as completed |
