...
- [Pre-1.0 readiness plan update](../plans/pre-1-0-readiness-plan-2026-06-05.md) — Active remaining-work tracker on the `0.x` line

---

> Historical scope note (2026-04-16): This proposal is preserved as roadmap and ADR input evidence. It is not an active current-state document; current release/readiness truth lives in [implementation-status.md](../plans/implementation-status-2026-06-06.md) and the active planning docs under [docs/planning/](../plans/planning-index-2026-06-06.md).
...
Tracked in the active [milestone plan](../plans/milestone-plan-2026-06-05.md) and [pre-1.0 readiness plan](../plans/pre-1-0-readiness-plan-2026-06-05.md).

### Updated planning index

New audit entry added to [planning-index.md](../plans/planning-index-2026-06-06.md).
