...
| Tests | 826 passing (578 core, 248 CLI) |
...
| Active readiness tracker | [Pre-1.0 Readiness Plan](pre-1-0-readiness-plan-2026-06-05.md) |
...
- **Publication checklist:** [Release publication checklist](../../project/release-publication-checklist.md) with local verification, tagging, NuGet publication, and self-contained binary steps.
...
- [Release Process](../../project/release-process.md) now explains how version bumps, changelog updates, labels, tagging, GitHub Releases, and automated NuGet publication fit together.
...
The detailed categorized list lives in [Pre-1.0 Readiness Plan](pre-1-0-readiness-plan-2026-06-05.md). At a high level, the remaining work is now concentrated in a smaller set of release-hardening items:
