...
Remaining stable-readiness work is tracked in [pre-1-0-readiness-plan.md](pre-1-0-readiness-plan-2026-06-05.md) and [milestone-plan.md](milestone-plan-2026-06-05.md).
