...
| Document | Purpose |
|----------|---------|
| [Implementation Status](implementation-status-2026-06-06.md) | Current runtime/package baseline, landed working-line scope, and remaining pre-stable gaps |
| [Pre-1.0 Readiness Plan](pre-1-0-readiness-plan-2026-06-05.md) | Categorized remaining work before the first stable shipment |

## Decisions

| Document | Purpose |
|----------|---------|
| [Decision Index](../../decisions/README.md) | Index of accepted RFCs and ADRs |
...
| Document | Purpose |
|----------|---------|
| [Workflow Guide](../../project/workflow-guide.md) | Canonical reference for how all categories of work should be performed in this repo |
| [Delivery Strategy](delivery-strategy.md) | Sequencing principles and versioning strategy |
| [Milestone Plan](milestone-plan-2026-06-05.md) | Delivered lineage plus the shipped `v0.17.0` and active `v0.18.0` pre-1.0 scope |
| [Repo Quality Hardening Pass Plan](repo-quality-hardening-pass-plan.md) | Execution plan for the April 18 implementation-quality hardening pass: must-fix clusters, behavior-preservation cautions, and explicit deferrals |
...
| [Pre-Release Blockers](pre-release-blockers.md) | Critical items that must be resolved before a first meaningful public pre-1.0 release |
| [Implementation Instructions](implementation-instructions-2026-06-05.md) | Contributor execution guide for the active pre-1.0 roadmap |
| [v0.15.0 Draft Preparation](v0-15-draft-preparation.md) | Historical preparation memo preserved as evidence for the shipped `v0.15.0` milestone |
| [RFC-007 Governance Enhancements Backlog](rfc-007-governance-enhancements-backlog.md) | Status ledger for accepted governance-enhancement items |
| [Future Enhancements Backlog](future-enhancements-backlog-2026-04-18.md) | Tracked enhancement concepts from the April 2026 draft-RFC review that do not yet warrant RFC-grade design authority |
| [Curation Notes](curation-notes-2026-06-05.md) | Provenance, superseded framing, and roadmap retargeting notes |
| [Release Process](../../project/release-process.md) | Authoritative operator guide for intentional public pre-1.0 releases, labels, changelog policy, tagging, and GitHub Releases |
| [Release Publication Checklist](../../project/release-publication-checklist.md) | Local verification, tagging, NuGet publication, and self-contained binary steps |
...
| [CLI Full Assessment — 2026-04-16](../stubs/cli-full-assessment-2026-04-16.md) | Stub — superseded by 2026-04-17/18 reviews; finding labels F1–F5 preserved for traceability |
| [CLI Expectation Fidelity Reassessment — 2026-04-16](../stubs/cli-expectation-fidelity-reassessment-2026-04-16.md) | Stub — superseded by 2026-04-17 assessment; finding labels F-01/F-02 preserved for traceability |
| [CLI Expectation Fidelity Review — 2026-04-16](../stubs/cli-expectation-fidelity-review-2026-04-16.md) | Stub — superseded by 2026-04-17 assessment; finding labels EF-001/EF-002 preserved for traceability |
| [Release Governance Conformance Review — 2026-04-16](../stubs/release-governance-conformance-review-2026-04-16.md) | Stub — superseded by 2026-04-17/18 release evidence; key decisions (ADR-014, RFC corrections) recorded in successor artifacts |
| [Repository Audit — 2026-04-14](../stubs/repository-audit-2026-04-14.md) | Stub — early requirement-driven audit; changes and key findings recorded in stub and synthesis |
| [Requirements Implementation Review — 2026-04-14](../stubs/review-requirements.md) | Stub — early per-requirement pass; remaining open items tracked in readiness plan |
...
| [Artifact Hygiene Cleanup Review — 2026-04-16](../stubs/artifact-hygiene-cleanup-review-2026-04-16.md) | Stub — prior classification-only cleanup pass; superseded by the 2026-04-18 curation pass |
...
| Document | Role |
|----------|------|
| [Master Requirements](../../requirements/master-requirements-source.md) | Original requirements source (MRD-0001) |
