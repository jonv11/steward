...
This document records the analysis behind the [Workflow Guide](../planning/workflow-guide.md). It captures what was learned from git history, which historical patterns were kept or corrected, and why the final workflow model was chosen.
