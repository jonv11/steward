...
| ADR-006: Output Formatting Strategy | [ADR-006-output-formatting-strategy.md](adrs/ADR-006-output-formatting-strategy.md) | Accepted | Defines text and JSON output, check-only SARIF export, stream contracts, and color handling |
